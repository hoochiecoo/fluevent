            ...
            child: ListView(
              ...
              children: [
                ...
                _buildSwitchTile(
                  ...
                  onChanged: (v) => setState(() { _grayscaleEnabled = v; _updateNativeSettings(); }),
                ),
                ...
                _buildSwitchTile(
                  ...
                  icon: Icons.blur_on,
                  value: _blurEnabled,
                  onChanged: (v) => setState(() { _blurEnabled = v; _updateNativeSettings(); }),
                ),
                const SizedBox(height: 10),
                _buildSwitchTile(
                  ...
                  value: _cannyEnabled,
                  onChanged: (v) => setState(() { _cannyEnabled = v; _updateNativeSettings(); }),
                ),
              ],
            ),
          ),
